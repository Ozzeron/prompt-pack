...
> **Detail:** read [Recurring high-signal finding patterns](references/finding-patterns.md) when you have the project map and want the known patterns to check against.
